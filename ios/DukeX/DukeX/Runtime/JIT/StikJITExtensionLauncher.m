...
// Private NSExtension surface used to launch and manage the runner process.
...
static NSString *const kStikJITListenerEndpointKey = @"DukeXStikJITListenerEndpoint";
...
// The embedded runner .appex lives in the app's PlugIns/ directory.
